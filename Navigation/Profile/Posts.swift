...
static let postArray = [
         PostVK(author: "BMW 8", description: "Учащает пульс, создан для ярких личностей. Новый BMW 8 серии Coupe — сочетание спортивного характера и эксклюзивности автомобилей BMW класса «люкс» — новый стандарт эстетического удовольствия.", image: "7", likes: 932, views: 3000),
